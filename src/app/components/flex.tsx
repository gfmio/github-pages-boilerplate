...
export interface IFlexBaseProps extends IAsComponentProps {
    expand?: boolean;
    collapse?: boolean;
}

export interface IFlexContainerProps extends IFlexBaseProps {
    inline?: boolean;
...
export const FlexContainer: React.StatelessComponent<IFlexContainerProps & React.HTMLAttributes<any>> =
    (props: IFlexContainerProps & React.HTMLAttributes<any>) => {
...
export interface IFlexChildProps extends IFlexBaseProps { }

export const FlexChild: React.StatelessComponent<IFlexChildProps & React.HTMLAttributes<any>> =
    (props: IFlexChildProps & React.HTMLAttributes<any>) => {
